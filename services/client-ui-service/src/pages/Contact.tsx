...
const Contact: React.FC = () => {
    const { user } = useUser();
    const [contactContent, setContactContent] = useState<ContactContent>({ section: null, items: [] });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary-50 to-white">
            ...
            <LoadingOverlay isLoading={loading} message="Loading contact information..." />
            ...
            <div className="relative w-full h-80 flex items-center justify-center bg-gradient-to-r from-green-900/90 to-green-700/80">
                ...
                <div className="relative z-10 text-center text-white px-4">
                    ...
                    <p className="text-lg md:text-2xl font-medium max-w-2xl mx-auto drop-shadow">
                        {contactContent.section?.content || "We're here to help you connect, exhibit, and grow at the Lagos International Trade Fair."}
                    </p>
                </div>
            </div>
            ...
            <section className="max-w-2xl mx-auto -mt-16 bg-white rounded-3xl shadow-xl p-8 md:p-12 relative z-20">
                ...
                {contactContent.section?.metadata?.main_office && (
                    <div className="mb-8">
                        <h2 className="text-2xl font-semibold mb-2 text-green-800">Main Office Contact</h2>
                        <div className="mb-4">
                            <p className="mb-1">{contactContent.section.metadata.main_office.address}</p>
                        </div>
                        <div className="mb-8 flex flex-col md:flex-row gap-8">
                            <div className="flex-1 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mb-2">{contactContent.section.metadata.main_office.phone}</p>
                                </div>
                            </div>
                            <div className="flex-1 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href={`mailto:${contactContent.section.metadata.main_office.email}`} className="text-primary-700 hover:underline">
                        ...
                        {contactContent.section.metadata.main_office.working_hours && (
                            <div className="mb-8">
                                ...
                                <p>{contactContent.section.metadata.main_office.working_hours}</p>
                            </div>
                        )}
                    </div>
                )}
                ...
                {contactContent.section?.metadata?.support_office && (
                    <div className="mb-8">
                        <h2 className="text-2xl font-semibold mb-2 text-green-800">Support Office Contact</h2>
                        <div className="mb-4">
                            <p className="mb-1">{contactContent.section.metadata.support_office.address}</p>
                        </div>
                        <div className="mb-8 flex flex-col md:flex-row gap-8">
                            <div className="flex-1 flex items-start gap-4">
                                <FaPhoneAlt className="text-green-700 text-2xl mt-1" />
                                <div>
                                    <h3 className="text-xl font-semibold mb-1">Phone</h3>
                                    <p className="mb-2">{contactContent.section.metadata.support_office.phone}</p>
                                </div>
                            </div>
                            <div className="flex-1 flex items-start gap-4">
                                <FaEnvelope className="text-red-500 text-2xl mt-1" />
                                <div>
                                    <h3 className="text-xl font-semibold mb-1">Email</h3>
                                    <a href={`mailto:${contactContent.section.metadata.support_office.email}`} className="text-primary-700 hover:underline">
                        ...
                        {contactContent.section.metadata.support_office.working_hours && (
                            <div className="mb-8">
                                <h3 className="text-xl font-semibold mb-2">Working Hours</h3>
                                <p>{contactContent.section.metadata.support_office.working_hours}</p>
                            </div>
                        )}
                    </div>
                )}
