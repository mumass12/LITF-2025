            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-8">
                ...
                <div className="md:col-span-2 flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 mt-2">
                        ...
                        <a href="https://www.x.com/lagoschamber88" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors"><FaXTwitter className="text-2xl" /></a>
                    </div>
                </div>
                {/* Quick Links */}
                <div>
