...
import { FaEnvelope, FaPhone, FaFacebook, FaInstagram, FaGlobe } from 'react-icons/fa';
...
const FooterSection: React.FC = () => {
    ...
    const [footerContent, setFooterContent] = useState<FooterContent>({ section: null, items: [] });
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-8">
                ...
                <div className="md:col-span-2 flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 mt-2">
                        <a href={footerContent.section?.metadata?.social_links?.facebook || "https://www.facebook.com/lagoschamber"} target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors"><FaFacebook className="text-2xl" /></a>
                        <a href={footerContent.section?.metadata?.social_links?.instagram || "https://www.instagram.com/lagos_tradefair"} target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors"><FaInstagram className="text-2xl" /></a>
                        <a href={footerContent.section?.metadata?.social_links?.twitter || "https://www.x.com/lagoschamber88"} target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors"><FaXTwitter className="text-2xl" /></a>
                    </div>
                </div>
                {/* Quick Links */}
                <div>
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-center gap-3">
                            ...
                            <a href={`mailto:${footerContent.section?.metadata?.email || "litf@lagoschamber.com"}`} className="hover:underline">
                                {footerContent.section?.metadata?.email || "litf@lagoschamber.com"}
                            </a>
                        </li>
                        <li className="flex items-center gap-3">
                            <FaPhone className="text-red-400" />
                            <a href={`tel:${footerContent.section?.metadata?.phone || "+2347005246724"}`} className="hover:underline">
